...
function NavBar() {
  return (
    <div>
      <nav className='bg-stone-50 border-gray-200 w-full z-40 top-0 start-0'>
        <div className='max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4'>
          ...
          >
            <img
              src='https://avatars.mds.yandex.net/i?id=42a4e629847559f2407d85e7e967dbd14ed360ef-10869405-images-thumbs&n=13'
              className='h-8'
              alt='UZDONGJU Logo'
            />
          </a>
          ...
          <div
            ...
            id='navbar-language'
          >
            <ul className='flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-stone-50'>
              <li>
                <a
                  href='#'
